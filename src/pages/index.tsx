...
const IndexPage: FC<{ data: Query }> = ({ data }) => {
  const sections = data.page.section.map(section => (
    <Section key={section.title} title={section.title}>
      <MarkdownRemark node={section.body} />
    </Section>
  ))
  ...
  return (
    <Layout>
      ...
      <Section title="Ett nytt hem för TF">
        <p>
          I ett nytt hus kan vi skapa utrymmen för TF:s medlemmar, en
          alumnilounge och en restaurang för samkväm. Traditionerna, kulturen
          och minnena från Urdsgjallar flyttar med medlemmarna till det nya
          huset.
        </p>
      </Section>
      <Statement>
      ...
      <Section title="TF idag">
        ...
        <p>
          ...
          gemensamt mål: lära känna nya personer och hitta sin plats i världen
          och samhället.
        </p>
        <p>
          ...
          Aalto-universitetet och fungerar som en naturlig länk till hela
          Norden.
        </p>
      </Section>
      ...
      <Section title="Nulägets utmaningar">
        ...
        <p>
          TF:s verksamhetsmiljö har ändrat dramatiskt sedan 60-talet: TF
          fungerar vid ett nytt och modernt universitet och nationshuset
          Urdsgjallar ligger avsides i dagens Otnäs, vars centrum är vid den nya
          metrostationen. Idag är Urdsgjallar dessutom nedslitet och i behov av
          grundrenovering. Huset står för 75 % av TF:s utgifter.
        </p>
        <p>
          TF:s verksamhetsmiljö har ändrat dramatiskt sedan 60-talet: TF
          fungerar vid ett nytt och modernt universitet och nationshuset
      ...
      <Section title="Träffpunkt Aalto som svar på utmaningarna">
        <p>
          Vi vill skapa Träffpunkt Aalto – ett vardagsrum för alla vid Aalto,
          ett hem för TF. En plats där kreativiteten flödar och nya kontakter
          knyts, en tvärvetenskaplig mötespunkt där studerande kan göra allt:
          skapa konst och musik, träffa företag, studera, sjunga snapsvisor,
          bygga nätverk, åta sig galna projekt, och främst av allt träffa sina
          vänner.
        </p>
        <p>
          ...
          möjliggör givande möten, både väntade och oväntade. Träffpunkt Aalto
          är också en kravlös och inspirerande miljö där man kan träffa dina
          vänner och vara med i gemenskapen. På Träffpunkt Aalto kan man också
      ...
      <Section title="Förverkligande av Träffpunkt Aalto">
        ...
        <p>
          ...
          Teknologföreningens utrymmen skapar en tydlig och självständig helhet
          i huset.
        </p>
        <p>
        ...
        <p>
          ...
          finansiera ett nybygge. Utöver detta kommer TF att göra
          penninginsamling för att försäkra finansieringen för de ideella
          utrymmena.
        </p>
        <p>
          ...
          alumnnätverk knyts oväntade men givande kontakter för livet. För de
          som vill utmana sig själva, testa sina vingar och lära sig nya
          färdigheter erbjuder Teknologföreningen också förtroendeuppdrag och
          större projekt – något som värdesätts av näringslivet.
        </p>
      </Section>
      <Statement>
